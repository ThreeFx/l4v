...
lemma preemption_point_empty_fail[wp, EmptyFail_AI_assms]:
  ...
  apply (clarsimp simp: preemption_point_def OR_choiceE_def andM_def ifM_def update_time_stamp_def
                        getCurrentTime_def get_sc_active_def)
  apply (wpsimp simp: mk_ef_def getActiveIRQ_def)
  done
